...
@Component({
  selector: 'app-assign-fee-type-one',
  templateUrl: './assign-fee-type-one.component.html',
  styleUrls: ['./assign-fee-type-one.component.scss']
})
export class AssignFeeTypeOneComponent {
  addForm:FormGroup;
  categoryList:any;
  rows: FormArray;
  classFees:any[] = [];
