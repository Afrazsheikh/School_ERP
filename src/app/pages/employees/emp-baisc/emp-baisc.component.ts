...
getDesignations() {
 ...
 createFrom(){
  ...
  this.empB1Form = this.fb.group({ 
      ...
      presentAddressZipCode: [this.empBasic?.presentAddressZipCode,[Validators.pattern("^((\\+91-?)|0)?[0-9]{6}$")]],
      ...
      permanentAddressZipCode: [this.empBasic?.premanentAddressZipCode, [Validators.required, Validators.pattern("^((\\+91-?)|0)?[0-9]{6}$")]],
