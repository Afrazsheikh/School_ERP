...
@Component({
  selector: 'app-mobile-payroll-invoice',
  templateUrl: './mobile-payroll-invoice.component.html',
  styleUrls: ['./mobile-payroll-invoice.component.scss']
})
export class MobilePayrollInvoiceComponent {
  employeeId!: string;
   monthAndYear!: Date;
   employeeDetail: any;
