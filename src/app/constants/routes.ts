export enum routes {
  ...
  BANNER="/parent/banner-list",
  NOTIFICATION="/parent/notification-list",
  NOTICE_BOARD="/parent/notice-board-list",
  TICKET_BOARD="/parent/ticket-list",
