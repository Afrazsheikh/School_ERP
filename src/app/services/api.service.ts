...
// Exam Master
  ...
  updateInvoiceStudentModeWise(postData: any): Observable<any> {
    return this.httpClient.put(environment.apiBaseUrl + '/updateModeStatus', postData).pipe(catchError(this.errorHandler));
  }
  ...
  feeTypeGroup(){
    ...
    removeAssignTechare(payload: any): Observable<any> {
      return this.httpClient.delete(environment.apiBaseUrl +'/academic/teacher/remove' ,{body:payload}).pipe(catchError(this.errorHandler));
    }
    ...
    getAllAcademicData(postData: any): Observable<any> {
      return this.httpClient.post(environment.apiBaseUrl +'/academic/details',postData ).pipe(catchError(this.errorHandler));
    }
    ...
    getAllFeeMode(): Observable<any> {
      return this.httpClient.get(environment.apiBaseUrl + '/getAllMode').pipe(catchError(this.errorHandler));
    }
    studenWiseFeeCategoryStore(postData: any): Observable<any> {
      return this.httpClient.post(environment.apiBaseUrl +'/createFeeConcession',postData ).pipe(catchError(this.errorHandler));
    }
    getAllFeeMonth(id: string): Observable<any> {
      return this.httpClient.get(environment.apiBaseUrl +'/allFeeMonth/' + id).pipe(catchError(this.errorHandler));
    }
    isEmptyObject(obj) {
